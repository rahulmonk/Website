...
# FIX: Changed '_content' to 'content' to match your folder structure
CONTENT_DIR = os.path.join(BASE_DIR, 'content')
# FIX: Changed '_templates' to 'templates' to match your folder structure
...
def generate_pages(items, content_type, template_name, env):
    ...
    for item in items:
        ...
        # Adjust the href for the final links
        item['href'] = f"{content_type}/{item['slug']}.html"
